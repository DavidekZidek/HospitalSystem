            ...
            modelBuilder.Entity("HospitalSystem.Domain.Entities.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 1, 28, 9, 20, 22, 775, DateTimeKind.Local).AddTicks(770),
                            Name = "Admin",
                            Password = "Admin123",
                            PersonalID = 0,
                            RoleId = 1
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 1, 28, 9, 20, 22, 775, DateTimeKind.Local).AddTicks(790),
                            Name = "DoctorJohn",
                            Password = "Doctor123",
                            PersonalID = 0,
                            RoleId = 2
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 1, 28, 9, 20, 22, 775, DateTimeKind.Local).AddTicks(800),
                            Name = "PatientJane",
                            Password = "Patient123",
                            PersonalID = 0,
                            RoleId = 3
                        ...
                        {
                            Id = 7,
                            CreatedAt = new DateTime(2025, 1, 28, 9, 20, 22, 775, DateTimeKind.Local).AddTicks(810),
                            Name = "PatientJane",
                            Password = "Patient123",
                            PersonalID = 0,
                            RoleId = 3
                        ...
                        {
                            Id = 13,
                            CreatedAt = new DateTime(2025, 1, 28, 9, 20, 22, 775, DateTimeKind.Local).AddTicks(820),
                            Name = "PatientAva",
                            Password = "Patient123",
                            PersonalID = 0,
                            RoleId = 3
                        ...
                        {
                            Id = 18,
                            CreatedAt = new DateTime(2025, 1, 28, 9, 20, 22, 775, DateTimeKind.Local).AddTicks(830),
                            Name = "PatientMason",
                            Password = "Patient123",
                            PersonalID = 0,
                            RoleId = 3
            ...
            modelBuilder.Entity("HospitalSystem.Domain.Entities.Results", b =>
                {
                    b.HasOne("HospitalSystem.Domain.Entities.Registration", "Registration")
                        .WithOne("Results")
                        .HasForeignKey("HospitalSystem.Domain.Entities.Results", "RegistrationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
